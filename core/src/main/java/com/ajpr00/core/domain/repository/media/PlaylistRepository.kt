 ...
 * PlaylistRepository
 *
 * Interfaz del dominio encargada de gestionar las playlists y sus relaciones
 * con los archivos multimedia. Define las operaciones básicas para:
 *
 *  - Obtener todas las playlists en tiempo real (Flow)
 *  - Crear y eliminar playlists
 *  - Añadir o quitar medias dentro de una playlist
 *  - Consultar una playlist junto con todos sus medias asociados
 *  - Insertar listas completas de medias de forma eficiente
 *  - Obtener una playlist existente o crearla si no existe
 */
