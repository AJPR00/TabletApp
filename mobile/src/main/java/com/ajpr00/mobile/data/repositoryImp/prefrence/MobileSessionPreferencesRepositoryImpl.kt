...
/**
 * Implementación del repositorio de sesión para la **app móvil**.
 *
 ...
 * Maneja datos temporales de sesión del usuario en el móvil:
 *
 ...
 */
class MobileSessionPreferencesRepositoryImpl @Inject constructor(
    ...
    override fun getAesToken(): Flow<String> = prefs.aesToken

    override suspend fun saveAesToken(token: String) =
        prefs.saveAesToken(token)
